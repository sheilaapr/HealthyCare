...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $insert_query = "INSERT INTO dokter (nama_dokter, spesialisasi, jadwal_konsul, rating, harga_konsultasi) VALUES ('$nama', '$spesialisasi', '$jadwal_konsul', '$rating', '$harga_konsultasi')";
    if ($conn->query($insert_query) === TRUE) {
        echo "<script>alert('Dokter berhasil ditambahkan.'); window.location='doctor.php';</script>";
    } else {
  ...
  <div class="container-fluid">
    ...
    <div class="container my-5">
        ...
        <form action="tambah_dokter.php" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="jadwal_konsul" class="form-control" required>
            </div>
            <div class="mb-3">
    ...
    <input type="number" name="rating" class="form-control" id="rating" step="0.1" min="0" max="5" required>
            ...
            <div class="form-group">
                ...
                <input type="number" name="harga_konsultasi" class="form-control" required>
            </div>
            <button type="submit" class="btn mt-4 btn-primary">Tambah Dokter</button>
